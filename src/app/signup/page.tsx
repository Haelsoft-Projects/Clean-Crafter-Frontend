  ...
  return (
    <div>
      <div className="bg-white flex flex-col lg:flex-row w-full min-h-screen  justify-between  gap-x-0 ">
        ...
        /> */}
  <div className="w-[80%] lg:w-[55%] xl:w-[55%] px-20 min-h-screen bg-gradient-to-t from-blue-900 to-blue-500 hidden  rounded-r-[50px] lg:flex justify-center items-center">
        <Image src={img} alt="dfasfasd" />
      </div>
      <div className=" lg:w-[45%] xl:w-[45%] flex  justify-center items-center lg:px-10 xl:px-24">
