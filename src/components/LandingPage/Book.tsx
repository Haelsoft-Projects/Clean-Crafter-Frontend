...
const Book = () => {
  return (
    <div>
      <div className="relative  sm:px-10 md:px-8 container mx-auto mt-20 mb-32 w-full h-[564px]">
        <Image
          src={bg}
          alt="background"
          className="lg:object-contain object-cover absolute -z-20 h-[564px] px-4 lg:px-0 sm:px-10 md:px-8 "
        />
        <div className="px-4 sm:px-10 md:px-8  lg:px-0"><p className="font-semibold text-[32px] text-center mt-10">
