    ...
    <div>
      <div className="bg-[#F3F2F2] w-full  py-20 min-h-[590px] mt-20 ">
        <div className="container mx-auto flex flex-col gap-x-5">
          ...
          <div className="flex flex-col gap-y-10 lg:flex-row mt-10 lg:mt-20 justify-between items-center ">
            <div className="h-[346px] w-[376px] flex flex-col items-center justify-center gap-y-4 bg-white p-5 rounded-lg ">
            ...
            <div className="h-[346px] w-[376px] flex flex-col items-center  justify-center gap-y-6 bg-white p-5 rounded-lg ">
